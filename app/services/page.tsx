      ...
      <section className="py-20 bg-slate-50">
        <div className="container mx-auto px-4">
          ...
          <div className="grid md:grid-cols-3 gap-8 max-w-5xl mx-auto">
            ...
            <Card className="text-center border-blue-600 border-2 relative">
              ...
              <CardHeader>
                ...
                <div className="text-3xl font-bold text-blue-600 mt-4">
                  $599<span className="text-lg text-slate-600">/month</span>
                </div>
              </CardHeader>
              <CardContent>
                <ul className="space-y-3 text-left">
            ...
            <Card className="text-center">
              ...
              <CardContent>
                <ul className="space-y-3 text-left">
                  ...
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-green-600" />
                    <span className="text-sm">Business consulting</span>
                  </li>
                  <li className="flex items-center gap-2">
                    <CheckCircle className="h-4 w-4 text-green-600" />
      ...
      <section className="py-20 bg-blue-600 text-white">
        <div className="container mx-auto px-4 text-center">
          ...
          <p className="text-xl mb-8 text-blue-100 max-w-2xl mx-auto">
            Let's discuss which services are right for your business. Schedule a free consultation today.
          </p>
